 ...
 */
package com.udacity.kmukunda.sunshine.app;
...
import com.udacity.kmukunda.sunshine.Util;
import com.udacity.kmukunda.sunshine.data.WeatherContract;
import com.udacity.kmukunda.sunshine.data.WeatherContract.LocationEntry;
import com.udacity.kmukunda.sunshine.data.WeatherContract.WeatherEntry;
...
public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
    ...
    private String formatHighLows(double high, double low) {
        ...
        if(Util.getTemperatureUnit(mContext).equals("F")) {
            roundedHigh = convertToF(roundedHigh);
            roundedLow = convertToF(roundedLow);
        }
    ...
    private long convertToF(long temp) {
        return (temp * 9)/5 + 32;
    }
    ...
    public long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        String selectionClause = LocationEntry.COLUMN_CITY_NAME + "=?";
        Uri uri = LocationEntry.CONTENT_URI;
        String[] selectionArgs = {cityName};
        final long locationId;

        Cursor cursor = contentResolver.query(uri, projection, selectionClause, selectionArgs, null);
        if (cursor.moveToFirst()) {
            ...
            locationId = ContentUris.parseId(contentResolver.insert(uri, values));
